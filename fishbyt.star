...
def main(config):
    ...
    if fish_pic==None: 
        print("No fish pic detected")
        fish_pic=base64.decode(FAIL_IMAGE)

    else: 
        
        print("Found fish pic")
...
def get_fish_barrel():
#should add or variable to protect against failure in case fishwatch cannot be reached
...
def pick_random_lines(facts):
    ...
    for i in range(0, len(facts)-1):
        ...
        # print("found in random line: "+random_fact)
        return random_fact
